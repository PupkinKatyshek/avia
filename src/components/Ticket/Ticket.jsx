      ...
      <div className={styles.Ticket__info}>
          ...
          <div className={styles.Ticket__column}>
            ...
            <div className={styles.Ticket__time}>
              ...
              {formatTime(
                formatDate(
                  new Date(
                    new Date(outboundSegment.date).getTime() +
                      outboundSegment.duration * 60000
                  )
                )
              )}
            </div>
          ...
          <div className={styles.Ticket__column}>
            ...
            <div className={styles.Ticket__time}>
              ...
              {formatTime(
                formatDate(
                  new Date(
                    new Date(returnSegment.date).getTime() +
                      returnSegment.duration * 60000
                  )
                )
              )}
            </div>
        ...
        <div className={styles.Ticket__row}>
          <div className={styles.Ticket__column}>
            ...
            <div className={styles.Ticket__timeLength}>
        ...
        <div className={styles.Ticket__row}>
          <div className={styles.Ticket__column}>
            <div className={styles["Ticket__stops-count"]}>
              {stopsCountText(outboundSegment.stops)}
            </div>
            <div className={styles["Ticket__stops-cities"]}>
              {stopsInfo(outboundSegment.stops)}
            </div>
          </div>
          <div className={styles.Ticket__column}>
            <div className={styles["Ticket__stops-count"]}>
              {stopsCountText(returnSegment.stops)}
            </div>
            <div className={styles["Ticket__stops-cities"]}>
              {stopsInfo(returnSegment.stops)}
            </div>
          </div>
        </div>
      </div>
